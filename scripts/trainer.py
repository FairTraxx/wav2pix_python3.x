...
class Trainer(object):
    def __init__(self, vis_screen, save_path, l1_coef, l2_coef, pre_trained_gen,
        ...
        self.optimD = torch.optim.Adam([p for p in self.discriminator.parameters() if p.requires_grad], lr=self.lr_D, betas=(self.beta1, 0.999))
        self.optimG = torch.optim.Adam([p for p in self.generator.parameters() if p.requires_grad], lr=self.lr_G, betas=(self.beta1, 0.999))
